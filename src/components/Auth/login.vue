...
const getRoleRedirect = (role) => {
    const configs = {
        ...
        'manager':  { path: "/manager/dashboard",   name: "Manager" },
        'agent':    { path: "/agent/dashboard",     name: "Agent" },
        'support':  { path: "/support/dashboard",   name: "Support" },
        'accounts': { path: "/accounts/dashboard",  name: "Accounts" },
        'customer': { path: "/customer/dashboard",  name: "Customer" },
    };
